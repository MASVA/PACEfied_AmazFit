...
public class TrainSelectDetailHeaderAdapter$HeadHolder$$ViewBinder<T extends com.huami.watch.train.ui.adapter.TrainSelectDetailHeaderAdapter.HeadHolder> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    View view;
    view = finder.findRequiredView(source, 2131492939, "field 'numberTrainDays'");
    target.numberTrainDays = finder.castView(view, 2131492939, "field 'numberTrainDays'");
    view = finder.findRequiredView(source, 2131492941, "field 'numberTrainMils'");
    target.numberTrainMils = finder.castView(view, 2131492941, "field 'numberTrainMils'");
